...
#define TRIGGER_THRESHOLD 50 // threshold for the trigger
...
extern bool trigger;         // default trigger

extern uint8_t idx;                                 // index for the buffer
extern unsigned char buffer[BUFFER_SIZE][CHANNELS]; // buffer for the samples
